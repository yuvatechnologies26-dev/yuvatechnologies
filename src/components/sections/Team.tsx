      ...
      <div className="container mx-auto container-px">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 max-w-6xl mx-auto">
          {team.map(([name, role, initials]) => (
            <div
              key={name}
              className="rounded-2xl bg-card border border-border p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-primary hover:shadow-lift"
            >
              <div className="grid h-20 w-20 mx-auto place-items-center rounded-full bg-gradient-brand font-display font-extrabold text-primary-foreground text-xl shadow-glow">
                {initials}
              </div>
